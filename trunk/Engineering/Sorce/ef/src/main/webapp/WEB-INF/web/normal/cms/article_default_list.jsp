...
<shiro:hasRole name="admin">
   ...
   <jsp:include page="/BBS/navbar.jsp" ></jsp:include>
	</shiro:lacksRole>	<div data-ui="header" class="J_header">
	<hr>
	<hr>
		<div class="h_left">
			<div class="l_nav">
                ...
                ">
					<div class="i_default">
						<a href="<%=path %>/cmsController/normal/article/list.do?type=tongguo"><span>全部文章</span><b></b></a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="J_content">
		...
		<div class="mt20 plr20">
			<form action="<%=path %>/cmsController/normal/article/list.do?type=tongguo" id="queryForm" method="POST">
								...
								<table>
									<thead>
										<tr>
											...
											<td><span>发布者</span></td>
											<td><span>阅读数</span></td>
											<td id="createDateTd" data-type="sort"><span>发布日期</span><i></i></td>
									...
									<tbody>
										<c:forEach items="${page.list }" var="p">
											<tr>
												...
												<td><div class="t_text tc" style="width:300px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;"><a href="<%=path%>/cmsController/article/content.do?id=${p.id}" >${p.content }</a></div>
												</td>
											</tr>
										</c:forEach>
									</tbody>
