  ...
  <div class="am-container">
    ...
    <div class="am-collapse am-topbar-collapse" id="collapse-head">
      ...
      <div class="am-topbar-right">
        <a href="<%=path %>/web/all/register.jsp" class="am-btn am-btn-secondary am-topbar-btn am-btn-sm"><span class="am-icon-pencil"></span> 注册</a>
      </div>

      <div class="am-topbar-right">
        <a href="<%=path %>/web/all/login.jsp" class="am-btn am-btn-primary am-topbar-btn am-btn-sm"><span class="am-icon-user"></span>登录</a>
      </div>
        <div class="am-topbar-right">
        <a href="<%=path %>/web/admin/login.jsp" class="am-btn am-btn-primary am-topbar-btn am-btn-sm"><span class="am-icon-user"></span>管理员登录</a>
      </div>
    </div>
  </div>
</header>
